                    ...
                    rpc.query({
                        ...
                        .then(function (result) {
                            ...
                            for (var k = 0; k < banks.length; k++) {
                                ...
                                total_amount = total_amount + balance[k];
                            ...
                            var total_with_curruency =  self.format_currency(currency, total_amount);
                            $('#current_bank_balance').append('<li><div > Total :</div><div>' + total_with_curruency + '</div></li>');
                        })
