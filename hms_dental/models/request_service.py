...
class RequestService(models.Model):
    _name = 'hms.request.dental'
    _description = 'Request Dental services'
    ...
    service_line = fields.One2many("dental.service.line","name",string="service lines")
    ...
    def create(self, vals):
        vals['name'] = self.env['ir.sequence'].next_by_code('hms.request.dental') or _('New')
...
class ServiceLines(models.Model):
    _name = 'dental.service.line'
    _description = 'dental services lines'

    name = fields.Many2one("hms.request.dental",string="Dental Service Request")
    service = fields.Many2one("hms.dental.service")
