    ...
    var r = function() {
        ...
        return t.prototype.encode = function(t, e, n) {
            ...
            for (var i = 0; i < t.length; i++)
                "L" == e[i] ? r += this.Lbinary[t[i]] : "G" == e[i] ? r += this.Gbinary[t[i]] : "R" == e[i] && (r += this.Rbinary[t[i]]),
                i < t.length - 1 && (r += n);
            return r
        }
        ,
    ...
    var r = function() {
        function t(e) {
            ...
            for (var r = 0; r < e.length; ++r)
                this.bytes.push(e.charCodeAt(r));
        ...
        t.prototype.nextA = function(t, e) {
            ...
            if (t[0] >= 200)
                r = t[0] - 105,
                t.shift(),
                99 === r ? n = this.nextC(t, e + 1) : 100 === r ? n = this.nextB(t, e + 1) : 98 === r ? (t[0] = t[0] > 95 ? t[0] - 96 : t[0],
                n = this.nextA(t, e + 1)) : n = this.nextA(t, e + 1);
            else {
                var i = t[0];
                r = i < 32 ? i + 64 : i - 32,
                t.shift(),
        ...
        t.prototype.nextB = function(t, e) {
            ...
            t[0] >= 200 ? (r = t[0] - 105,
            t.shift(),
            99 === r ? n = this.nextC(t, e + 1) : 101 === r ? n = this.nextA(t, e + 1) : 98 === r ? (t[0] = t[0] < 32 ? t[0] + 96 : t[0],
            n = this.nextB(t, e + 1)) : n = this.nextB(t, e + 1)) : (r = t[0] - 32,
            t.shift(),
            n = this.nextB(t, e + 1));
        ...
        t.prototype.nextC = function(t, e) {
            ...
            t[0] >= 200 ? (r = t[0] - 105,
            t.shift(),
            n = 100 === r ? this.nextB(t, e + 1) : 101 === r ? this.nextA(t, e + 1) : this.nextC(t, e + 1)) : (r = 10 * (t[0] - 48) + t[1] - 48,
            t.shift(),
            t.shift(),
            n = this.nextC(t, e + 1));
            var i = this.getEncoding(r)
...
, function(t, e) {
    ...
    var o = function(t) {
        function e(i, o) {
            ...
            return s.name = "InvalidInputException",
            s.symbology = i,
            s.input = o,
            s.message = '"' + s.input + '" is not a valid input for ' + s.symbology,
            s
        }
        return i(e, t),
        e
      ...
      , s = function(t) {
        function e() {
            ...
            return i.name = "InvalidElementException",
      ...
      , a = function(t) {
        function e() {
            n(this, e);
            var i = r(this, t.call(this));
            return i.name = "NoElementException",
...
, function(t, e, n) {
    ...
    function c(t, e, n) {
        var r;
        r = "undefined" == typeof n ? document.createElement("canvas").getContext("2d") : n,
...
, function(t, e, n) {
    ...
    var a = n(3)
      ...
      , c = function(t) {
        function e(n) {
            return i(this, e),
            o(this, t.call(this, String.fromCharCode(208) + n))
        }
        return s(e, t),
...
, function(t, e, n) {
    ...
    var a = n(3)
      ...
      , c = function(t) {
        function e(n) {
            return i(this, e),
            o(this, t.call(this, String.fromCharCode(209) + n))
        }
        return s(e, t),
        e.prototype.valid = function() {
...
, function(t, e, n) {
    ...
    var a = n(3)
      ...
      , c = function(t) {
        function e(n) {
            return i(this, e),
            o(this, t.call(this, String.fromCharCode(210) + n))
        }
        return s(e, t),
        e.prototype.valid = function() {
...
, function(t, e, n) {
    ...
    function a(t) {
        ...
        return e = i >= 2 ? String.fromCharCode(210) + f(t) : n > r ? String.fromCharCode(208) + u(t) : String.fromCharCode(209) + c(t),
    ...
    function f(t) {
        ...
        return r >= i ? e + String.fromCharCode(206) + u(t) : e + String.fromCharCode(205) + c(t)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    });
...
, function(t, e) {
    ...
    var r = function() {
        ...
        return t.prototype.getEncoding = function(t) {
        ...
        t.prototype.encode = function() {
            for (var t = this.string, e = this.getEncoding("*"), n = 0; n < this.string.length; n++)
...
, function(t, e, n) {
    ...
    var o = n(0)
      ...
      , a = function() {
        function t(e, n) {
            i(this, t),
            e.search(/^[0-9]{12}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e,
            this.displayValue = n.displayValue,
            this.structure = ["LLLLLL", "LLGLGG", "LLGGLG", "LLGGGL", "LGLLGG", "LGGLLG", "LGGGLL", "LGLGLG", "LGLGGL", "LGGLGL"],
            n.fontSize > 10 * n.width ? this.fontSize = 10 * n.width : this.fontSize = n.fontSize,
        ...
        t.prototype.encode = function() {
            ...
            this.lastChar && this.displayValue && (e.push({
                data: "00"
            }),
            e.push({
                data: "00000",
      ...
      , a = function() {
        ...
        t.prototype.encode = function() {
            var t = new s["default"]
              ...
              , n = "1011";
            return n += t.encode(this.string, e, "01"),
            {
                data: n,
                text: this.string
            }
      ...
      , a = function() {
        ...
        t.prototype.encode = function() {
            var t = new s["default"]
              , e = this.checksum()
              , n = "1011";
            return n += t.encode(this.string, this.structure[e], "01"),
            {
                data: n,
                text: this.string
            }
        ...
        t.prototype.checksum = function() {
            var t = 0;
            return t += 3 * parseInt(this.string[0]),
...
, function(t, e, n) {
    ...
    var o = n(0)
      ...
      , a = function() {
        function t(e) {
            i(this, t),
            e.search(/^[0-9]{7}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e
        }
        return t.prototype.valid = function() {
...
, function(t, e, n) {
    ...
    var o = n(0)
      ...
      , a = function() {
        function t(e, n) {
            i(this, t),
            e.search(/^[0-9]{11}$/) !== -1 ? this.string = e + this.checksum(e) : this.string = e,
            this.displayValue = n.displayValue,
            n.fontSize > 10 * n.width ? this.fontSize = 10 * n.width : this.fontSize = n.fontSize,
            this.guardHeight = n.height + this.fontSize / 2 + n.textMargin
        }
...
, function(t, e) {
    ...
    var r = function() {
        ...
        t.prototype.calculatePair = function(t) {
            for (var e = "", n = this.binaryRepresentation[t[0]], r = this.binaryRepresentation[t[1]], i = 0; i < 5; i++)
                e += "1" == n[i] ? "111" : "1",
                e += "1" == r[i] ? "000" : "0";
            return e
        }
...
, function(t, e, n) {
    ...
    function i(t) {
        ...
        for (var n in u["default"])
            u["default"].hasOwnProperty(n) && (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())),
      ...
      , u = function() {
        ...
        t.prototype.drawCanvasBarcode = function(t, e) {
            ...
            for (var o = 0; o < i.length; o++) {
                ...
                "1" === i[o] ? r.fillRect(s, n, t.width, t.height) : i[o] && r.fillRect(s, n, t.width, t.height * i[o])
            }
        }
        ,
        t.prototype.drawCanvasText = function(t, e) {
            ...
            if (t.displayValue) {
                var i, o;
                o = "top" == t.textPosition ? t.marginTop + t.fontSize - t.textMargin : t.height + t.textMargin + t.marginTop + t.fontSize,
                n.font = r,
                "left" == t.textAlign || e.barcodePadding > 0 ? (i = 0,
                n.textAlign = "left") : "right" == t.textAlign ? (i = e.width - 1,
                n.textAlign = "right") : (i = e.width / 2,
                n.textAlign = "center"),
    ...
    var u = n(2)
      ...
      , l = function() {
        ...
        return t.prototype.render = function() {
            ...
            for (var e = 0; e < this.encodings.length; e++) {
                var n = this.encodings[e]
                  , r = (0,
                c["default"])(this.options, n.options)
        ...
        t.prototype.prepareSVG = function() {
            ...
            (0,
            f.calculateEncodingAttributes)(this.encodings, this.options);
            var t = (0,
            f.getTotalWidthOfEncodings)(this.encodings)
              , e = (0,
            f.getMaximumHeightOfEncodings)(this.encodings)
        ...
        t.prototype.drawSvgBarcode = function(t, e, n) {
            ...
            for (var o = 0, s = 0, u = 0; u < i.length; u++)
                ...
                "1" === i[u] ? o++ : o > 0 && (a(s - e.width * o, r, e.width * o, e.height, t),
                o = 0);
        ...
        t.prototype.drawSVGText = function(t, e, n) {
            ...
            if (e.displayValue) {
                ...
                "left" == e.textAlign || n.barcodePadding > 0 ? (i = 0,
                r.setAttribute("text-anchor", "start")) : "right" == e.textAlign ? (i = n.width - 1,
                r.setAttribute("text-anchor", "end")) : (i = n.width / 2,
        ...
        t.prototype.setSvgAttributes = function(t, e) {
            ...
            this.options.background && (n.style.background = this.options.background)
        }
        ,
        t
    }();
...
, function(t, e, n) {
    ...
    function i(t, e) {
        C.prototype[e] = C.prototype[e.toUpperCase()] = C.prototype[e.toLowerCase()] = function(n, r) {
            ...
            return i._errorHandler.wrapBarcodeCall(function() {
                var s = (0,
                h["default"])(i._options, r)
                  , a = t[e]
                  , u = o(n, a, s);
                return i._encodings.push(u),
                i
            })
        }
    }
    function o(t, e, n) {
        ...
        var r = new e(t,n);
        if (!r.valid())
            throw new x.InvalidInputException(r.constructor.name,t);
        var i = r.encode();
        i = (0,
        d["default"])(i);
        for (var o = 0; o < i.length; o++)
            i[o].options = (0,
            h["default"])(n, i[o].options);
        return i
    }
    function s() {
    ...
    function a(t, e, n) {
        ...
        for (var r = 0; r < e.length; r++)
            e[r].options = (0,
            h["default"])(n, e[r].options),
            (0,
            g["default"])(e[r].options);
        (0,
        g["default"])(n);
        var i = t.renderer
    ...
    C.prototype.init = function() {
        ...
        for (var e in this._renderProperties) {
            ...
            var n = (0,
            h["default"])(this._options, t.options);
    ...
    C.prototype.render = function() {
        if (Array.isArray(this._renderProperties))
            ...
            a(this._renderProperties, this._encodings, this._options);
        return this
    }
    ,
